...
module.exports = grammar({
    ...
    rules: {
        ...
        class_decl: ($) => seq("class", optional($.type_params), field("name", $.identifier), optSeq(":", field("super", $.identifier)), optional($.class_body)),
        ...
        // Class body
        class_body: ($) => seq("{", optional($.enum_entries), repeat($._declaration), "}"),
        property: ($) => prec.right(seq(choice("var", "val"), field("name", $.identifier), optSeq(":", field("type", $._type)), optChoice($.delegate, seq("=", $._expression)), optSeq(endl, choice(seq($.getter, optSeq(endl, $.setter)), seq($.setter, optSeq(endl, $.getter)))))),
        ...
        enum_entry: ($) => seq(field("name", $.identifier), optional($.args), optional($.class_body)),
        // Expression
